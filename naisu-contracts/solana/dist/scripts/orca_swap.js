...
async function main() {
    ...
    let quote;
    try {
        quote = await (0, whirlpools_sdk_1.swapQuoteByInputToken)(pool, WSOL_MINT, amountIn, SLIPPAGE_BPS / 10000, // as decimal fraction
        whirlpools_sdk_1.ORCA_WHIRLPOOL_PROGRAM_ID, ctx.fetcher, true);
    }
    catch (err) {
